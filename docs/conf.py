...
project = "test gh darwin py312-test-open-source"
...
release = metadata.version("test_gh_darwin_py312_test_open_source")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-gh-darwin-py312-test-open-source",
